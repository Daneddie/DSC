    ...
    return (
        <div 
            ...
            <div id="dsclogo">
                <a 
                    href="/"
                    className="flex flex-row items-center gap-2 text-[20px] md:text-[34px] text-[#3d3d3d] font-black">
                    <img src={dscLogo} alt="DSC Logo" className=" w-[30px] md:w-[40px] md:leading-3" />
            ...
            <div 
                ...
                className={`
                    ...
                    md:p-0 bg-[#ffffff] md:bg-transparent w-full z-20 gap-5 
